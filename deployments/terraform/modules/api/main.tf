...
resource "aws_lambda_function" "applicant_atlas_api" {
  ...
  image_uri     = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/${aws_ecr_repository.applicant_atlas_api_lambda.name}:b19c537d84af789a5979550e373048a7746bb4cc"

...
resource "aws_lambda_function" "applicant_atlas_api" {
  ...
  image_uri     = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/${aws_ecr_repository.applicant_atlas_api_lambda.name}:0a8272fbd68ed2e9aadcda8989ef92d79b547b2b"
